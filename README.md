...
./mvnw package
```
It produces the `singletton-1.0.0-SNAPSHOT-runner.jar` file in the `/target` directory.
...
The application is now runnable using `java -jar target/singletton-1.0.0-SNAPSHOT-runner.jar`.
...
You can then execute your native executable with: `./target/singletton-1.0.0-SNAPSHOT-runner`
